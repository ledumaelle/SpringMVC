	...
	<body>
		...
		<div class="container my-3 py-3 z-depth-1">
			<div class="row d-flex justify-content-center">
				<div class="col-md-6">
					<h1 class="text-center mb-4">Modification du film</h1>

					<form:form action="${pageContext.servletContext.contextPath}/app/films/updateFilm" method="POST" class="mt-5" modelAttribute="film">

						<form:hidden path="id" />
						<div class="form-outline mb-4">
							<form:input id="titre" path="titre" cssClass="form-control"/>
							<label class="form-label" for="titre">Titre</label>
							<form:errors path="titre" cssClass="alert-danger"/>
						</div>
						...
						<div class="row mb-4">
							<div class="col">
								<div>
									...
									<div class="col-xs-10">
										...
										<form:errors path="style.id" cssClass="alert-danger"/>
									</div>
								</div>
							</div>
							<div class="col d-flex justify-content-center align-items-end">
								<div class="form-outline form-check">
									...
									<form:errors path="vu" cssClass="alert-danger"/>
								</div>
							</div>
						</div>
						...
						<div class="row mb-4">
							<div class="col">
								<div class="form-outline">
									...
									<form:errors path="duree" cssClass="alert-danger"/>
								</div>
							</div>
							<div class="col">
								<div class="form-outline">
									...
									<form:errors path="annee" cssClass="alert-danger"/>
								</div>
							</div>
						</div>
